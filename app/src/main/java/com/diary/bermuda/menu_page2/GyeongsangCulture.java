...
public class GyeongsangCulture extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag2_gyeongsang_culture, container, false);
        ...
        String areaCode = "4";              //지역 선택 (현재: 경상) 4, 6, 7, 35, 36

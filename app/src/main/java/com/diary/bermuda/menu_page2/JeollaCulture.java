...
public class JeollaCulture extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag2_jeolla_culture, container, false);
        ...
        String areaCode = "5";              //지역 선택 (현재: 전라) 5, 37, 38,

...
public class GyeongsangTour extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag2_gyeongsang_tour, container, false);
        ...
        String areaCode = "4";              //지역 선택 (현재: 경싱) 4, 6, 7, 35, 36

...
public class ChungcheongFestival extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag2_chungcheong_festival, container, false);
        ...
        String areaCode = "3";             //지역 선택 (현재: 충청) 3, 8 , 33 ,34
...
//                        System.out.println("START_TAGSTART_TAGSTART_TAG");
                        ...
                        if(parser.getName().equals("message")){ //message 태그를 만나면 에러 출력
                            status1.setText(status1.getText()+"해당정보를 불러올 수 없습니다.");

...
public class GyeonggiTour extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag2_gyeonggi_tour, container, false);
        ...
        //http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=3pVWxOczmyxGKCn4OaKaf7QowzdpCgfeB64B%2Fw4RopLskhamZ4VJ1Ij9p0nvV%2BBw0SRwCV5A251lZgcpsMTXKw%3D%3D&pageNo=1&numOfRows=10000&MobileApp=AppTest&MobileOS=ETC&arrange=B&contentTypeId=12&areaCode=2&areaCode=31&listYN=Y
        ...
        String contentTypeId="12";          //카테고리 선택 (현재: 관광지)
        String areaCode = "2";              //지역 선택 (현재:인천)

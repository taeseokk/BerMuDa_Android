...
public class ChungcheongCulture extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag2_chungcheong_culture, container, false);
        ...
        String contentTypeId="14";          //카테고리 선택 (현재: 문화)
